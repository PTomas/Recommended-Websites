...
past.addEventListener("click", function getHistory() {
  ...
  let url = `https://recommendsy-b0bfb62a4d06.herokuapp.com/array/:${savedUser}`;
  let history = [];
  fetch(url)
      .then(res => {
          return res.json();
...
searchBtn.addEventListener("click", function() {
  ...
  let url = `https://recommendsy-b0bfb62a4d06.herokuapp.com/array/:${userId}`;
  let history = [];
  fetch(url)
      .then(res => {
          return res.json();
